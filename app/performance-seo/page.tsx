...
export const metadata: Metadata = { ...baseMetadata, title: 'Performance & SEO | Primus Software', description: 'Technical SEO and Core Web Vitals optimisation that drives organic traffic and rankings.' }
