...
export const metadata: Metadata = { ...baseMetadata, title: 'Website & Web App Development', description: 'End-to-end website and web app development - scalable, secure, and optimised.' }
