...
export const metadata: Metadata = { ...baseMetadata, title: 'eCommerce Development | Primus Software', description: 'Scalable ecommerce platforms engineered for revenue.' }
